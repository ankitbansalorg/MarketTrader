...
public class InstrumentRepositoryTest {
    ...
    @Before
    public void setUp() {
        mongoTemplate.dropCollection(Instrument.class);
    }
    ...
    @Test
    public void shouldRetrieveInstrumentsForGivenParamsInOrder() {
        ...
        Instrument instrument5 = new Instrument("NIFTY", OPTION, 6200, PUT, getDate("2-MAR-2008"), getDate("27-MAR-2008")); // in criteria
        Instrument instrument6 = new Instrument("NIFTY", FUTURE, 6000, PUT, getDate("2-MAR-2008"), getDate("27-MAR-2008")); //instrument type wrong
        Instrument instrument7 = new Instrument("ABB", OPTION, 6000, PUT, getDate("2-MAR-2008"), getDate("27-MAR-2008")); // symbol wrong
        Instrument instrument8 = new Instrument("NIFTY", OPTION, 6450, PUT, getDate("1-MAR-2008"), getDate("27-MAR-2008")); //in criteria
        ...
        List<Instrument> expectedInstruments = Arrays.asList(instrument8, instrument5, instrument1);
        assertEquals(3, retrievedInstruments.size());
